...
CREATE TABLE patients (patientID INTEGER PRIMARY KEY NOT NULL, patientLogin TEXT, patientPassword TEXT, patientName TEXT NOT NULL, patientLName TEXT NOT NULL, patientEmail TEXT, patientContact TEXT NOT NULL, patientBirthDate DATE NOT NULL);
...
CREATE TABLE commonPasswords (password TEXT NOT NULL);

INSERT INTO accounts VALUES (null, "admin", "admin", "Administrator", "", "admin@admin.net", 2);